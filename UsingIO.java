...
public class UsingIO
{
  ...
  public boolean addSysCallReader(SysCallReader aSysCallReader)
  {
    ...
    if (aSysCallReader.indexOfUsingIO(this) != -1)
    {
      wasAdded = true;
    }
    else
    {
      wasAdded = aSysCallReader.addUsingIO(this);
      if (!wasAdded)
      {
  ...
  public boolean removeSysCallReader(SysCallReader aSysCallReader)
  {
    ...
    {
      wasRemoved = aSysCallReader.removeUsingIO(this);
      if (!wasRemoved)
      {
  ...
  public void delete()
  {
    ...
    {
      aSysCallReader.removeUsingIO(this);
    }
  }
