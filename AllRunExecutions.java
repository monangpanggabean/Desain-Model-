...
public class AllRunExecutions
{
  ...
  public boolean addAnyAction(AnyActions aAnyAction)
  {
    ...
    if (aAnyAction.indexOfAllRunExecution(this) != -1)
    {
      wasAdded = true;
    }
    else
    {
      wasAdded = aAnyAction.addAllRunExecution(this);
      if (!wasAdded)
      {
  ...
  public boolean removeAnyAction(AnyActions aAnyAction)
  {
    ...
    {
      wasRemoved = aAnyAction.removeAllRunExecution(this);
      if (!wasRemoved)
      {
  ...
  public void delete()
  {
    ...
    {
      aAnyAction.removeAllRunExecution(this);
    }
  }
