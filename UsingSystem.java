...
public class UsingSystem
{
  ...
  public boolean addSysCallReader(SysCallReader aSysCallReader)
  {
    ...
    if (aSysCallReader.indexOfUsingSystem(this) != -1)
    {
      wasAdded = true;
    }
    else
    {
      wasAdded = aSysCallReader.addUsingSystem(this);
      if (!wasAdded)
      {
  ...
  public boolean removeSysCallReader(SysCallReader aSysCallReader)
  {
    ...
    {
      wasRemoved = aSysCallReader.removeUsingSystem(this);
      if (!wasRemoved)
      {
  ...
  public void delete()
  {
    ...
    {
      aSysCallReader.removeUsingSystem(this);
    }
  }
