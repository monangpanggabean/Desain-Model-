...
public class Parameters
{
  ...
  public boolean addSysCallReader(SysCallReader aSysCallReader)
  {
    ...
    if (aSysCallReader.indexOfParameter(this) != -1)
    {
      wasAdded = true;
    }
    else
    {
      wasAdded = aSysCallReader.addParameter(this);
      if (!wasAdded)
      {
  ...
  public boolean removeSysCallReader(SysCallReader aSysCallReader)
  {
    ...
    {
      wasRemoved = aSysCallReader.removeParameter(this);
      if (!wasRemoved)
      {
  ...
  public void delete()
  {
    ...
    {
      aSysCallReader.removeParameter(this);
    }
  }
